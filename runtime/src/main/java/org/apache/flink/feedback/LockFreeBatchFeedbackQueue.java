 ...
 */
package org.apache.flink.feedback;

import org.apache.flink.queue.Locks;
import org.apache.flink.queue.MpscQueue;
...
public final class LockFreeBatchFeedbackQueue<ElementT> implements FeedbackQueue<ElementT> {
    ...
    private final MpscQueue<ElementT> queue =
            new MpscQueue<>(INITIAL_BUFFER_SIZE, Locks.spinLock());
